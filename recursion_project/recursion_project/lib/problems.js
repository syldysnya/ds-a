...
function lucasNumber(n) {
    ...
    let total = lucasNumber(n-2) + lucasNumber(n-1);
    return total
}
...
function sumArray(array) {
    ...
    let total = firstNum + sumArray(nextArr)
    return total
}
...
function reverseString(str) {
    ...
    let nextStr = str.slice(0, str.length - 1);

    return lastChar + reverseString(nextStr);
}
